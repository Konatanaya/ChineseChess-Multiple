...
import javax.media.opengl.GLCanvas;
 ...
 public class GLOrbitCameraNode extends GLLookAtCameraNode {
        ...
        public GLOrbitCameraNode(String nodeName, GLSceneGraph sceneGraph, GLCanvas canvas, Point3D at, double height, double radius) {
            super(nodeName, sceneGraph, new Point3D(at.getX() + radius, at.getY() + height, at.getZ()), at, new Vector3D(0, 1, 0));
            this.radius = radius;
            this.height = height;
            this.canvas = canvas;
        ...
        private void updateEye() {
            eye.set(at.getX() + radius * Math.cos(theta), at.getY() + height, at.getZ() + radius * Math.sin(theta));
        }
